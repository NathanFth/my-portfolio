    ...
    <>
      ...
      <section id="detail-tugas">
        <div className="wrapper">
          ...
          {/* Jika Tugas 1 → tampilkan konten Logika FOL */}
          {id === "1" && (
            <>
              {/* Section 1 */}
              <div className="section-box">
                ...
                <p className="section-paragraph">
                  <strong className="section-subtitle">Pengertian:</strong>{" "}
                  Logika First Order (First Order Logic/FOL) adalah sistem
                  logika yang menggunakan predikat, kuantor, dan variabel untuk
                  menyatakan fakta tentang objek di dunia nyata.
                </p>
                <div className="section-paragraph">
                  ...
                  <ul className="section-list">
                    ...
                    <li>
                      Menyatakan sifat objek dengan predikat (misalnya:
                      Manusia(x))
                    </li>
                ...
                <div className="section-paragraph">
                  ...
                  <ul className="section-list">
                    <li>
                      ∀x (Demam(x) ∧ Batuk(x) → Flu(x)) → Semua yang demam dan
                      batuk menderita flu
                    </li>
                    <li>
              ...
              <div className="section-box">
                ...
                <p className="section-paragraph">
                  <strong className="section-subtitle">Kesimpulan:</strong>{" "}
                  Semua mahasiswa ilmu komputer paham pemrograman
                </p>
                <div className="section-paragraph">
                ...
                <p className="section-paragraph">
                  <strong className="section-subtitle">Kesimpulan:</strong> ∀x
                  (K(x) → P(x))
                  <br />
              ...
              <div className="section-box">
                ...
                <div className="section-paragraph">
                  ...
                  <ol className="section-list-numbered">
                    <li>
                      Asumsikan x adalah pear dan tidak kuning → R(x) ∧
                      ¬W(x,kuning)
                    </li>
                    <li>Dari (1): pear adalah buah → B(x)</li>
                    <li>
                      Dari (2): karena buah harus berwarna kuning, hijau, atau
                      merah, dan pear tidak boleh merah (3), dan tidak kuning →
                      maka W(x,hijau)
                    </li>
                    <li>
                      Dari (4): jika buah berwarna hijau → tidak manis →
                      W(x,hijau) → ¬S(x)
                    </li>
                ...
                <p className="section-conclusion">
                  Pernyataan "Jika pear tidak kuning maka pear tidak manis"
                  adalah <span className="underline">BENAR</span> dan terbukti
                  logis dari premis yang ada.
                </p>
              </div>
            </>
          )}

          {/* Jika Tugas 2 → tampilkan komponen sistem pakar */}
          {id === "2" && <SistemPakar />}
